...
import TestPage from "./components/Student/TestPage/TestPage.js";
import StudentSubmissions from "./components/Student/Submissions/StudentSubmissions";
import ViewTests from "./components/Student/ViewTests/ViewTests";
...
import CreateTest from "./components/Teacher/CreateTest/CreateTest.js";
    ...
    <Router>
      <Routes>
        ...
        >
          ...
          <Route path="test/:id" element={<TestPage />} />  {/* ✅ Fixed the absolute path issue */}
